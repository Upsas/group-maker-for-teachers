<div class="fixed z-10 overflow-y-auto top-0 w-full left-0 <?php echo e($hidden); ?>" id="modal">
            ...
            <div class="container border-b-0 mx-auto">
                <div class="max-w-xl p-5 mx-auto my-10 bg-white rounded-md">
                    <div class="text-center">
                        <h1 class="my-3 text-3xl font-semibold text-gray-700"><?php echo e(__('Add project')); ?></h1>
                        <p class="text-gray-400 mb-3"><?php echo e(__('Fill up the form below to add a project.')); ?></p>
                    </div>
                 ...
                 class="inline w-10  text-center
                    ...
                    <form wire:loading.remove wire:submit.prevent="store" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-6">
                            <label for="name" class="block mb-2 text-sm text-gray-600 <?php $__errorArgs = ['name'];
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> text-red-500 border-red-500 <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>"
                        ...
                        <div class="flex flex-col sm:flex-row items-center mb-5 sm:space-x-5">
                            <div class="w-full sm:w-1/2">
                                ...
                                <label for="groups" class="block mb-2 text-sm text-gray-600  <?php $__errorArgs = ['groups'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> text-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                ><?php echo e(__('Groups number')); ?></label>
                                <input
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <div class="w-full sm:w-1/2 mt-2 sm:mt-0 ">
                                ...
                                <label for="students_per_group"
                                       class=" mb-2 text-sm text-gray-600 <?php $__errorArgs = ['students_per_group'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> text-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(__('Students per group')); ?></label>
                                <input
                                    ...
                                    class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md
                                    focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300
                                    <?php $__errorArgs = ['students_per_group'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> text-red-500 border-red-500 <?php unset($message);
...
<?php /**PATH /var/www/html/resources/views/livewire/project-add-form.blade.php ENDPATH**/ ?>