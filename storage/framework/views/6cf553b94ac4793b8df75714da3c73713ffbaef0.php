<div class="fixed z-10 overflow-y-auto top-0 w-full left-0 <?php echo e($hiddenStudentForm); ?>" id="student-add-form">
            ...
            <div class="container border-b-0 mx-auto">
                <div class="max-w-xl p-5 mx-auto my-10 bg-white rounded-md">
                    <div class="text-center">
                        <h1 class="my-3 text-3xl font-semibold text-gray-700"><?php echo e(__('Add student')); ?></h1>
                        <p class="text-gray-400 mb-3"><?php echo e(__('Fill up the form below to add a student.')); ?></p>
                    </div>
                    ...
                    <form wire:loading.remove wire:submit.prevent="storeStudent" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-6">
                            <label for="full_name" class="block mb-2 text-sm text-gray-600 <?php $__errorArgs = ['full_name'];
...
<?php /**PATH /var/www/html/resources/views/livewire/add-student-form.blade.php ENDPATH**/ ?>