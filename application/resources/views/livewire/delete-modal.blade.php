<div class="fixed z-10 overflow-y-auto top-0 w-full left-0 {{$displayModalStyle}}" id="delete-modal">
            ...
            <div class="container border-b-0 mx-auto">
                <div class="max-w-xl p-5 mb-2 mx-auto my-10 bg-white rounded-md">
                    <div class="text-center">
                        <h1 class="my-3 text-3xl font-semibold text-gray-700">{{__('Are you sure?')}}</h1>
                        <p class="text-gray-400 mb-3">{{__('Do you really want to delete a student?')}}</p>
                    </div>
